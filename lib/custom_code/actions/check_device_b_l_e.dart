...
Future<bool> checkDeviceBLE(String deviceId) async {
  final bleManager = BleManager();

  // Initialize when your app starts (after Firebase initialization)
  return await bleManager.claimDevice(deviceId);
}
