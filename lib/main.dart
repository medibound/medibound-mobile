...
import 'package:medibound_portal_hdztzw/flutter_flow/internationalization.dart'
    as medibound_portal_hdztzw_internationalization;
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = mediboundMobileFirebaseUserStream()
      ..listen((user) {
