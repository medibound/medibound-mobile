...
DocumentReference? get currentUserReference => loggedIn
    ? medibound_portal_hdztzw_backend.UsersRecord.collection
        .doc(currentUser!.uid)
    : null;

medibound_portal_hdztzw_backend.UsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : medibound_portal_hdztzw_backend.UsersRecord.getDocument(
                  medibound_portal_hdztzw_backend.UsersRecord.collection
                      .doc(uid))
              .handleError((_) {}),
    )
